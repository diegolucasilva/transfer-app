...
internal class TransferMoneyControllerTest{
    ...
    private fun givenTransferMoneyRequest(fromAccount: String, toAccount: String, amount: Double): HttpEntity<TransferMoneyDTORequest> {
    ...
    private fun givenAccountInDataBase(number: String, customerDocumentId: String, balance: Double,status: Int): AccountEntity{
